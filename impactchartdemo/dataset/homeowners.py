"""Homeowner demographics data set for the impact chart demo."""
...
FEATURE_MEDIAN_HOUSEHOLD_INCOME = "B19013_001E"
...
ADDITIONAL_VARIABLES = {
    ...
    FEATURE_MEDIAN_HOUSEHOLD_INCOME: "Median Household Income",
...
def _states_in_cbsa(cbsa: str, vintage: int = 2020):
    ...
    ).download(dataset=ACS5, vintage=vintage, download_variables=["NAME"], state="*")

    return list(df_states["STATE"])


def all_cbsas(vintage: int = 2020):
...
def get_data(
    ...
    return X, y, w, feature_names, TARGET_NAME
